...
```
curl -L https://raw.githubusercontent.com/wise2c-devops/breeze/v1.14.10/docker-compose.yml -o docker-compose.yml
curl -L https://raw.githubusercontent.com/wise2c-devops/breeze/v1.14.10/docker-compose-centos.yml -o docker-compose.yml
curl -L https://raw.githubusercontent.com/wise2c-devops/breeze/v1.14.10/docker-compose-ubuntu.yml -o docker-compose.yml
```
