...
[![Build Status](https://travis-ci.org/wise2c-devops/breeze.svg?branch=v1.11)](https://travis-ci.org/wise2c-devops/breeze)
...
**Kubernetes集群节点:** 兼容CentOS 7.4/7.5/7.6 版本，Minimal安装模式是推荐的方式，为了确保部署的顺利进行，应尽可能保证系统的干净。
