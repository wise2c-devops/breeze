...
**Kubernetes集群节点:** 兼容RHEL/CentOS/RockyLinux/AlmaLinux/OracleLinux 8.4+ 、Ubuntu 20/22 LTS 以及 openEuler 22.03 LTS SP3 版本，Minimal安装模式是推荐的方式，为了确保部署的顺利进行，应尽可能保证系统的干净。
