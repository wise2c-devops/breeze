...
**Kubernetes集群节点:** 兼容RHEL/CentOS/OracleLinux 7.4+以及RHEL/CentOS/RockyLinux/AlmaLinux/OracleLinux/Anolis 8.4+ 以及 Ubuntu 18/20 LTS 版本，Minimal安装模式是推荐的方式，为了确保部署的顺利进行，应尽可能保证系统的干净。
