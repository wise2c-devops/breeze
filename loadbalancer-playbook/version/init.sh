...
sed -i "s/1.8.14/${haproxy_version}/g" ../template/haproxy-run.sh.j2
sed -i "s/1.8.14/${haproxy_version}/g" ../install.ansible
sed -i "s/1.3.5/${keepalived_version}/g" ../install.ansible
