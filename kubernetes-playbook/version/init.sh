...
docker run --rm --name=kubeadm-version wise2c/kubeadm-version:${k8s_version} kubeadm config images list --kubernetes-version ${k8s_version} > ${path}/k8s-images-list.txt
