...
for file in $(grep -lr "grafana/grafana" kube-prometheus-$KubePrometheusVersion/manifests/); do cat $file |grep "grafana/grafana" |grep -v "runbook_url" ; done >> image-lists-temp.txt
